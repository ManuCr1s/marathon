...
{{-- Va la clase maraton--}}
    <div class="container-fluid">
        <div class="container mb-5 p-5 paper mt-5">
            <div class="row">
                <div class="col-md-3">
            ...
            --}}
				<p class="d-none d-md-block">La inscripcion para la maraton internacional mas alta del mundo meseta del <b>BOMBON</b> - 2023 ha concluido</p>
			</div>
