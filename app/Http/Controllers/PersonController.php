...
class PersonController extends Controller
{
    ...
    private $message =[
        ...
        'format01.file' => ['status'=>'false','message'=>'El archivo debe ser un archivo válido.'],
        'format01.max' => ['status'=>'false','message'=>'El archivo debe ser un archivo válido.'],
        'format01.mimes' => ['status'=>'false','message'=>'El archivo debe ser un archivo válido.'],
        'format02.file' => ['status'=>'false','message'=>'El archivo debe ser un archivo válido.'],
        'format02.max' => ['status'=>'false','message'=>'El archivo no debe superar los 5 MB.'],
        'format02.mimes' => ['status'=>'false','message'=>'El archivo debe ser de tipo PDF'],
        'format03.required' => ['status'=>'false','message'=>'El documento del FORMATO 03 es obligatorio'],
        'format03.file' => ['status'=>'false','message'=>'El archivo debe ser un archivo válido.'],
        'format03.max' => ['status'=>'false','message'=>'El archivo no debe superar los 5 MB.'],
        'format03.mimes' => ['status'=>'false','message'=>'El archivo debe ser de tipo PDF'],
        'format04.required' => ['status'=>'false','message'=>'El documento del FORMATO 04 es obligatorio'],
        'format04.file' => ['status'=>'false','message'=>'El archivo debe ser un archivo válido.'],
        'format04.max' => ['status'=>'false','message'=>'El archivo no debe superar los 5 MB.'],
        'format04.mimes' => ['status'=>'false','message'=>'El archivo debe ser de tipo PDF'],
    ];
    /**
